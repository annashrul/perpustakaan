...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Produk By anasrulysf.com">
    <meta name="author" content="Anasrulysf">
    <title><?=$title?></title>
  ...
  <style type="text/css">
    ...
    .alert-primary,.alert-info,.alert-danger,.alert-default,.alert-dark,.alert-success,.alert-warning{border-radius:0px;}
  </style>